...
public class XmlHandler {
    ...
    public static java.io.InputStream getXmlStream(String path) throws Exception {
        if (Gdx.files != null) {
            return Gdx.files.internal(path).read();
        } else {
            java.io.File file = new java.io.File("core/assets/" + path);
            if (!file.exists()) {
    ...
    public static ArrayList<Items> loadWeapons() {
        ...
        try {
            ...
            Document doc = dBuilder.parse(getXmlStream("data/weapons.xml"));
    ...
    public static ArrayList<Items> loadArmors() {
        ...
        try {
            DocumentBuilderFactory dbFactory = DocumentBuilderFactory.newInstance();
            DocumentBuilder dBuilder = dbFactory.newDocumentBuilder();
            Document doc = dBuilder.parse(getXmlStream("data/armors.xml"));
            doc.getDocumentElement().normalize();
    ...
    public static ArrayList<Items> loadArtefacts() {
        ...
        try {
            DocumentBuilderFactory dbFactory = DocumentBuilderFactory.newInstance();
            DocumentBuilder dBuilder = dbFactory.newDocumentBuilder();
            Document doc = dBuilder.parse(getXmlStream("data/artefacts.xml"));
            doc.getDocumentElement().normalize();
    ...
    public static ArrayList<Items> loadUsables() {
        ...
        try {
            DocumentBuilderFactory dbFactory = DocumentBuilderFactory.newInstance();
            DocumentBuilder dBuilder = dbFactory.newDocumentBuilder();
            Document doc = dBuilder.parse(getXmlStream("data/usables.xml"));
            doc.getDocumentElement().normalize();
